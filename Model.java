...
public class Model extends Observable
{
  ...
  public void createGameObjects()
  {
    synchronized( Model.class )
    {
      ...
      {
    	for (int y = 0; y < BRICKS / 2; y++) 
    	{
    		bricks.add(new GameObj((W / 2) - (x * (BRICK_WIDTH * 1.5f)) + (BRICK_WIDTH * 4.7f), (H / 2) - (y * 60), BRICK_WIDTH, BRICK_HEIGHT, Colour.BLUE));
    	}  
      }
    }
  }
  ...
  private boolean checkBrickHit(float ballX, float ballY) 
  {
	  boolean hit = false;
